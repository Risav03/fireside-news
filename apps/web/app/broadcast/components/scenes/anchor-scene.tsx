...
export function AnchorScene({ category }: { category: string }) {
  return (
    <div className="absolute inset-0 grid place-items-[end_center]">
      <div className="absolute right-[8%] bottom-[88px] left-[8%] h-[110px] rounded-t-lg border-t-2 border-white/10 bg-[linear-gradient(180deg,#17130f,#0c0e14)] shadow-[0_-8px_24px_rgba(0,0,0,0.4)] before:absolute before:top-7 before:left-1/2 before:-translate-x-1/2 before:font-[var(--display)] before:text-[28px] before:font-bold before:tracking-[0.16em] before:text-[var(--brand)] before:content-['FIRESIDE'] before:[text-shadow:0_0_12px_rgba(235,107,52,0.5)] after:absolute after:top-[60px] after:left-1/2 after:-translate-x-1/2 after:text-[12px] after:font-bold after:tracking-[0.4em] after:text-[var(--gold)] after:content-['NEWS']" />
      <div className="absolute bottom-[200px] left-[6%] aspect-[16/10] w-[22%] overflow-hidden rounded border border-[var(--line)] bg-[#0c0e14] shadow-[0_8px_32px_rgba(0,0,0,0.5),inset_0_0_24px_rgba(235,107,52,0.12)]">
        <div className="h-full w-full p-3">
          <Sparkline up />
        </div>
      </div>
      <div className="absolute right-[6%] bottom-[200px] aspect-[16/10] w-[22%] overflow-hidden rounded border border-[var(--line)] bg-[#0c0e14] shadow-[0_8px_32px_rgba(0,0,0,0.5),inset_0_0_24px_rgba(235,107,52,0.12)]">
        <div className="grid h-full w-full place-items-center bg-[radial-gradient(circle,rgba(235,107,52,0.25),transparent_70%)] p-3">
